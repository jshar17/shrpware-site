...
export default function WavePlumeChangelog() {
  return <PageShell accent="waveplume"><ArticleHero eyebrow="WavePlume / Changelog" title="WavePlume release notes." intro="Current version, download, and release information." />
