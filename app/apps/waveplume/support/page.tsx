  ...
  return (
    <main className="legal-page wave-legal">
      ...
      <article className="legal-content">
        <p className="product-overline">WAVEPLUME / SUPPORT</p><h1>How can we help?</h1>
        <p className="legal-lede">WavePlume records meetings and transcribes them locally. For a question, bug report, or request, email <a href="mailto:wavequillsupport@gmail.com">wavequillsupport@gmail.com</a>.</p>
