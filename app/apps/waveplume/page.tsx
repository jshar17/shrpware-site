  ...
  return (
    <main className="product-page wave-page">
      <header className="product-header">
        <Brand />
        <nav><a href="/">Store</a><a href="/apps/waveplume/support">Support</a><a href="/apps/waveplume/privacy">Privacy</a></nav>
      </header>
      ...
      <section className="product-hero">
        ...
        <div className="product-hero-media">
          <img src="/apps/waveplume/ready.jpg" alt="WavePlume recording setup screen" />
        </div>
      </section>
