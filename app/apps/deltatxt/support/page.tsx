...
export const metadata: Metadata = { title: "DeltaTxt support", description: "Installation and troubleshooting help for DeltaTxt Python debugging, find and replace, text comparison, and large files on Windows.", alternates: { canonical: "/apps/deltatxt/support" } };

export default function DeltaTxtSupport() {
  return <PageShell><ArticleHero eyebrow="DeltaTxt / Support" title="DeltaTxt support." intro="Help with Python run and debug, find and replace, text comparison, installation, and recovery." />
    <article className="article-body wrap"><BackToApp href="/apps/deltatxt">Back to DeltaTxt</BackToApp><h2>Fast checks</h2><div className="faq-list">
      <details open><summary>Python will not run or debug</summary><p>Confirm the selected interpreter exists and runs from Windows outside DeltaTxt. Refresh interpreter discovery, then check the saved arguments, working directory, and environment values for the script.</p></details>
