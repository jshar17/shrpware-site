...
export default function DeltaTxtPrivacy() {
  return <PageShell accent="deltatxt"><ArticleHero title="How DeltaTxt handles your data." intro="Effective August 12, 2026. DeltaTxt is a local desktop app with no account, telemetry, analytics, advertising, or automatic crash submission." />
