...
export default function PressPage() {
  return <PageShell><ArticleHero eyebrow="ShrpWare / Press kit" title="ShrpWare press kit." intro="Product descriptions, facts, screenshots, icons, and contact information for coverage and app listings." />
    <article className="article-body wrap press-body">
      ...
      <div className="press-assets"><a href="/apps/waveplume/app-assets/png/waveplume-128.png" download>Download icon</a><a href="/apps/waveplume/hero-windows-transcript-20260906.webp" download>Download product image</a><Link href="/apps/waveplume">Product page</Link></div>
