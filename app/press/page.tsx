...
export default function PressPage() {
  return <PageShell><ArticleHero title="ShrpWare press kit." intro="Product descriptions, facts, screenshots, icons, and contact information for coverage and app listings." />
    <article className="article-body wrap press-body">
      ...
      <div className="press-assets"><a href="/apps/deltatxt/icon.png" download>Download icon</a><a href="/apps/deltatxt/gallery/mac-code-editor.webp" download>Download product image</a><Link href="/apps/deltatxt">Product page</Link></div>
