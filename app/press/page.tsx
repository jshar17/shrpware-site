...
export default function PressPage() {
  return <PageShell><ArticleHero eyebrow="ShrpWare / Press kit" title="ShrpWare press kit." intro="Product descriptions, facts, screenshots, icons, and contact information for coverage and app listings." />
    <article className="article-body wrap press-body">
      ...
      <div className="press-assets"><a href="/apps/waveplume/app-assets/png/waveplume-128.png" download>Download icon</a><a href="/apps/waveplume/hero-windows-transcript-20260907.webp" download>Download product image</a><Link href="/apps/waveplume">Product page</Link></div>
      <h2>DeltaTxt</h2><p><strong>One line:</strong> DeltaTxt is a free text and code workbench built natively for Mac in Swift and available on Windows, with workspace search, comparison, and merge tools.</p><ul><li>macOS 13 or later, Windows 10 and 11</li><li>Native Swift and AppKit Mac edition</li><li>Freeware</li><li>No account, telemetry, advertising, or subscription</li></ul>
      <div className="press-assets"><a href="/apps/deltatxt/icon.png" download>Download icon</a><a href="/apps/deltatxt/gallery/mac-edit-with-focus.webp" download>Download product image</a><Link href="/apps/deltatxt">Product page</Link></div>
