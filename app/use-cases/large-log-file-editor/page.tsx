...
export default function LargeLogs() {
  return <SeoLanding title="Edit large log files on Windows." intro="Use DeltaTxt to open large logs, find error messages across related files, compare output, and run cleanup scripts." app="DeltaTxt" appHref="/apps/deltatxt" cta="See DeltaTxt" image="/apps/deltatxt/gallery/windows-code-without-overhead.webp" imageAlt="A technical file open in DeltaTxt">
