...
export default function WaveComparison() {
  return <PageShell accent="waveplume"><ArticleHero title="WavePlume vs. cloud meeting bots." intro="Both create searchable meeting transcripts. The main differences are whether a bot joins the call and where the audio is processed and stored." />
