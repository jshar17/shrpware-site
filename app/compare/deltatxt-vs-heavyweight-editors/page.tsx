...
export default function DeltaComparison() {
  return <PageShell accent="deltatxt"><ArticleHero title="DeltaTxt vs. a full Python IDE." intro="DeltaTxt keeps Python editing and debugging beside powerful find, replace, comparison, and merge tools. A full IDE covers the wider software project." />
