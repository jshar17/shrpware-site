...
export default function DeltaComparison() {
  return <PageShell accent="deltatxt"><ArticleHero eyebrow="Comparison / Python + text" title="DeltaTxt vs. a full Python IDE." intro="DeltaTxt keeps Python editing and debugging beside powerful find, replace, comparison, and merge tools. A full IDE covers the wider software project." />
    <article className="article-body wrap">
      <div className="comparison-table comparison-table-wide"><div className="comparison-row comparison-head"><span>Need</span><strong>DeltaTxt</strong><span>Full Python IDE</span></div><div className="comparison-row"><span>Primary focus</span><strong>Python scripts + technical text</strong><span>Whole-project development</span></div><div className="comparison-row"><span>Python run and debug</span><strong>Breakpoints, stepping, Locals, Stack</strong><span>Broader project debugger</span></div><div className="comparison-row"><span>Find and replace</span><strong>Document, workspace, and large-file tools</strong><span>Usually project search</span></div><div className="comparison-row"><span>Compare and merge</span><strong>Central workflow</strong><span>Usually one feature among many</span></div><div className="comparison-row"><span>Project tooling</span><strong>Deliberately focused</strong><span>Refactoring, builds, VCS, plugins</span></div><div className="comparison-row"><span>Price</span><strong>Freeware</strong><span>Varies</span></div></div>
