...
export function SeoLanding({
  ...
  return <PageShell accent={accent}>
    ...
    <section className="closing-cta wrap" data-arrival><p className="section-number">AVAILABLE IN {app.toUpperCase()}</p><h2>Use {app} for this workflow.</h2><Link className="button button-primary" href={appHref}>{cta}</Link></section>
  </PageShell>;
}
